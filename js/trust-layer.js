...
(function () {
    ...
    const CALCULATORS = {
        'car-vs-taxi.html': {
            ...
            input: 'Один годовой объём поездок, цена автомобиля, расходы на владение, средняя длина поездки и тариф такси.',
            scenario: 'Один и тот же пробег применяется в обоих сценариях. Количество поездок такси и их цена выводятся из длины поездки и тарифа. Альтернативная доходность капитала включается в итог автомобиля только при активном переключателе.',
        ...
        'millionaire.html': {
            ...
            scenario: 'В режиме цели в будущих рублях сумма фиксирована. В режиме сегодняшних рублей цель растёт с исторической средней инфляцией, а график и капитал показываются в сегодняшних рублях.',
