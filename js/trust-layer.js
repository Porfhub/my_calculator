...
(function () {
    ...
    const CALCULATORS = {
        ...
        'wealth.html': {
            ...
            input: 'Среднемесячная начисленная зарплата до НДФЛ, включая регулярные премии и надбавки, и выбранный субъект.',
            scenario: 'Дополнительной модели нет: процент показывает только разницу между введённой зарплатой и опубликованным ориентиром.',
            result: 'Разница с доступными официальными значениями. Это не место в распределении и не рейтинг.',
            limitation: 'Калькулятор сравнивает зарплату. Он не измеряет богатство, качество жизни, доход домохозяйства или социальный класс. Метрики без проверенного официального источника не показываются.'
        }
    };
